...
#define MAXPROCESS		8 // 7 processes available to user.
...
/**
 * \return a non-NULL service_t descriptor if successful; NULL otherwise.
 *
 *  Initialize a new, non-NULL service_t descriptor.
 */
